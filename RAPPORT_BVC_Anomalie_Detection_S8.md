...
│  Filière  :  [Votre filière — CAC / CI / PSCM / Autre]              │
│                                                                       │
...
│  ─────────────────────────────────────────────────────────────────  │
│                                                                       │
│  <!-- 📸 EMPLACEMENT PHOTO ÉTUDIANT                                  │
│       Remplacer cette ligne par :                                     │
│       ![Photo](./assets/photo_etudiant.jpg)                          │
│       (format recommandé : 3×4, fond blanc, tenue professionnelle)   │
│  -->                                                                  │
│                                                                       │
└─────────────────────────────────────────────────────────────────────┘
```
...
Mes remerciements s'adressent en premier lieu à **[Titre et Nom de l'encadrant]**, dont l'encadrement rigoureux, les conseils avisés et la disponibilité permanente ont été déterminants dans l'aboutissement de ce travail.
...
Ma reconnaissance va aussi à **[Nom d'un éventuel partenaire ou institution]** pour l'accès aux ressources documentaires et aux outils numériques qui ont facilité la conduite de cette étude.
...
> ```
> Exporter depuis le notebook la sortie de la cellule 10 (Figure 1)
> Enregistrer sous : ./assets/figure1_desequilibre_classes.png
> Puis insérer ici :
> ![Figure 1 — Déséquilibre des Classes et Types d'Anomalies](./assets/figure1_desequilibre_classes.png)
> ```
...
> ```
> Exporter depuis le notebook la sortie de la cellule 12 (Figure 2)
> Enregistrer sous : ./assets/figure2_distributions_variables.png
> Puis insérer ici :
> ![Figure 2 — Distributions des Variables par Classe](./assets/figure2_distributions_variables.png)
> ```
...
> ```
> Exporter depuis le notebook la sortie de la cellule 14 (Figure 3)
> Enregistrer sous : ./assets/figure3_anomalies_secteur_titre.png
> Puis insérer ici :
> ![Figure 3 — Anomalies par Secteur et par Titre](./assets/figure3_anomalies_secteur_titre.png)
> ```
...
> ```
> Exporter depuis le notebook la sortie de la cellule 16 (Figure 4)
> Enregistrer sous : ./assets/figure4_matrice_correlation.png
> Puis insérer ici :
> ![Figure 4 — Matrice de Corrélation](./assets/figure4_matrice_correlation.png)
> ```
...
> ```
> Exporter depuis le notebook la sortie de la cellule 22 (Figure 5)
> Enregistrer sous : ./assets/figure5_comparaison_performances.png
> Puis insérer ici :
> ![Figure 5 — Comparaison des Performances des Modèles](./assets/figure5_comparaison_performances.png)
> ```
...
> ```
> Exporter depuis le notebook la sortie de la cellule 24 (Figure 6)
> Enregistrer sous : ./assets/figure6_matrices_confusion.png
> Puis insérer ici :
> ![Figure 6 — Matrices de Confusion](./assets/figure6_matrices_confusion.png)
> ```
...
> ```
> Exporter depuis le notebook la sortie de la cellule 26 (Figure 7)
> Enregistrer sous : ./assets/figure7_courbes_roc_pr.png
> Puis insérer ici :
> ![Figure 7 — Courbes ROC et Précision-Rappel](./assets/figure7_courbes_roc_pr.png)
> ```
...
> ```
> Exporter depuis le notebook la sortie de la cellule 28 (Figure 8)
> Enregistrer sous : ./assets/figure8_importance_variables.png
> Puis insérer ici :
> ![Figure 8 — Importance des Variables (Random Forest)](./assets/figure8_importance_variables.png)
> ```
...
> ```
> Exporter depuis le notebook la sortie de la cellule 30 (Figure 9)
> Enregistrer sous : ./assets/figure9_validation_croisee.png
> Puis insérer ici :
> ![Figure 9 — Validation Croisée 5-Fold (Boxplots)](./assets/figure9_validation_croisee.png)
> ```
...
> ```
> Exporter depuis le notebook la sortie de la cellule 34 (Figure 10)
> Enregistrer sous : ./assets/figure10_seuil_decision.png
> Puis insérer ici :
> ![Figure 10 — Seuil de Décision Optimal](./assets/figure10_seuil_decision.png)
> ```
...
8. [Votre référence complémentaire 1]
9. [Votre référence complémentaire 2]
